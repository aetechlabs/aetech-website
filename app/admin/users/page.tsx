  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-700 text-white p-8"
      >
        ...
        {(['ADMIN', 'AUTHOR', 'USER'] as const).map((role, index) => (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className={`p-3 rounded-lg ${getRoleColor(role)} bg-opacity-20`}>
                <span className="text-2xl">{getRoleIcon(role)}</span>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">{role}S</h3>
          ...
          <div className="text-center py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
              <div className="bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 rounded-lg p-4 border border-violet-200 dark:border-violet-800">
                <h4 className="font-medium text-violet-800 dark:text-violet-300 mb-2">🔐 Role Management</h4>
              ...
              <div className="bg-gradient-to-r from-fuchsia-50 to-pink-50 dark:from-fuchsia-900/20 dark:to-pink-900/20 rounded-lg p-4 border border-fuchsia-200 dark:border-fuchsia-800">
                <h4 className="font-medium text-fuchsia-800 dark:text-fuchsia-300 mb-2">📊 User Analytics</h4>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 bg-gradient-to-r from-violet-500 to-purple-500 rounded-full flex items-center justify-center text-white font-medium">
                  ...
                  <div className="flex items-center space-x-3">
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${getRoleColor(user.role)} bg-opacity-20`}>
                      {user.role}
                    </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-600">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getRoleColor(user.role)} bg-opacity-20`}>
                        {user.role}
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex items-center space-x-3">
                  <select
                    ...
                    className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 bg-white dark:bg-gray-800"
                  >
