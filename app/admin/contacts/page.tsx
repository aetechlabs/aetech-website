  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 text-white p-4 sm:p-6 lg:p-8"
      >
        ...
        <div className="relative">
          <div className="flex items-center gap-3 sm:gap-4 mb-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold">Contact Messages</h1>
              <p className="text-white/80 mt-1 text-sm sm:text-base">Manage and respond to customer inquiries</p>
            </div>
          </div>
        </div>
      </motion.div>
          ...
          <div className="space-y-6">
            <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 mb-6">
              ...
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm font-medium flex items-center justify-center sm:justify-start space-x-2"
              >
            ...
            <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 mb-6">
              {/* Contact Statistics */}
              <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4 order-2 lg:order-1">
                {(() => {
                  ...
                  return (
                    <>
                      <select
                        ...
                        className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white dark:bg-gray-800 min-w-0 flex-1 sm:flex-none"
                      >
              ...
              return filteredContacts.map((contact, index) => {
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:items-start sm:justify-between sm:space-y-0 mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center text-white font-medium text-sm">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {(contact.phone || contact.country) && (
                        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 text-xs text-gray-400 dark:text-gray-500 mt-1 space-y-1 sm:space-y-0">
                          {contact.phone && (
                  ...
                  <div className="flex flex-col space-y-2 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-2">
                    <span className={`px-3 py-1 rounded-full text-xs font-medium self-start ${getStatusColor(contact.status)}`}>
                      {contact.status}
                    </span>
                ...
                <div className="mb-4">
                  <p className="font-medium text-gray-900 dark:text-gray-100 mb-2 text-sm sm:text-base break-words">
                    Subject: {contact.subject}
                  </p>
                  
                  {/* Original Message */}
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-200 dark:border-gray-600 mb-4">
                    <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base break-words">{projectDetails.originalMessage}</p>
                  </div>
                ...
                <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-3">
                  <select
                    ...
                    className="w-full sm:w-auto px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white dark:bg-gray-800"
                  >
